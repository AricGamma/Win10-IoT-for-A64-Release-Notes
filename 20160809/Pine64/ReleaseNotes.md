...
*   **Kernel Version:** Windows 10 IoT Core version 1511
    ...
    This is the first released version of Windows 10 IoT Core for Pine 64. Only part of features enabled and  we will keep developing and update in time.This document will introduce how to deploy Windows 10 IoT Core to a Pine 64 board and note known issues.
...
*   Wifi and Ethernet are not available. Please use a USB ethernet adapter or USB wifi adapter instead temporarily.
*   USB port is not available directly. If you want to use some USB devices including USB wifi and ethernet adapter, please use a USB hub as intermediary.
...
> We will fix these issues and update the image as soon as possible.